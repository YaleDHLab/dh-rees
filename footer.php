  ...
  <div class="footer-blue">
    ...
    <div class="footer-icon-container">
      <div class="footer-icon footer-icon-email">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="3991.282 1654 23.343 14.585">
          <defs>
            <style>
              .cls-1 {
                fill: #fff;
      ...
      <div class="footer-icon footer-icon-facebook">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="4047 1648 12.146 26.017">
          <defs>
            <style>
              .cls-1 {
                fill: #fff;
          ...
          <path id="path-16" class="cls-1" d="M151.618,127.089v3.577H149v4.341h2.618v13.008h5.4V135.008h3.61s.341-2.1.5-4.39h-4.1v-2.992a1.268,1.268,0,0,1,1.171-1.057h2.943V122H157.13C151.488,122,151.618,126.439,151.618,127.089Z" transform="translate(3898 1526)"/>
        </svg>
      </div><!-- .footer-icon (facebook) -->

      <div class="footer-icon footer-icon-github">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="4084 1651 38.867 29.814">
          <defs>
            <style>
              .cls-1 {
                fill: #fff;
